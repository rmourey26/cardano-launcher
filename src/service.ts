...
export async function writeStatusEntry(service: StartService<any>, pid: number, logger: Logger) {
  const entry = _.assign({ service: service.command, pid }, service.status.info);
